# cyoa-maker
A tool that allows you to build your own Choose Your Own Adventure stories with dynamic elements and world-building tools. Currently built with Node, Express, and the EJS templating language.
